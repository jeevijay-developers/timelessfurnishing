                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
                  ...
                  <div className="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed text-sm lg:text-base">
                      Discover our exclusive deal of the day! Enjoy unbeatable prices on premium furniture and home decor.
                      Shop now to upgrade your space with style and comfort. Hurry, this offer is available for a limited time only!
                    </p>
              ...
              <div className="mx-auto max-w-screen-2xl px-3 sm:px-10">
                ...
                <div className="text-center mb-12">
                  ...
                  <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
                    Discover premium furniture collections with exceptional quality and modern design.
                    Transform your space with our curated selection of contemporary pieces.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="flex items-center gap-4 text-white">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">Best Quality Guarantee</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 text-white">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Win $100 To Shop</h3>
                  ...
                  <div className="flex items-center gap-4 text-white">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Best Online Support</h3>
                      <p className="text-gray-300 text-sm">Hour: 10:00AM - 5:00PM</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mx-8">
                  ...
                  <div className="lg:col-span-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      We collaborate with leading brands and trusted partners to bring you the finest furniture
                      and home decor solutions. Our partnerships ensure quality, reliability, and exceptional value
                      for our customers.
                    </p>
                  </div>
                  ...
                  <div className="lg:col-span-1">
                    <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                      <Image src="/partners/acer.jpg" alt="Acer Logo" width={150} height={40} />
                      <Image src="/partners/samsung.jpg" alt="Samsung Logo" width={150} height={40} />
                      <Image src="/partners/nokia.jpg" alt="Nokia Logo" width={150} height={40} />
                      <Image src="/partners/sony.jpg" alt="Sony Logo" width={150} height={40} />
                      <Image src="/partners/xaomi.jpg" alt="Xiaomi Logo" width={150} height={40} />
                      <Image src="/partners/ticwatch.jpg" alt="Ticwatch Logo" width={150} height={40} />
                      <Image src="/partners/lemfo.jpg" alt="Lemfo Logo" width={150} height={40} />
                      <Image src="/partners/lenovo.jpg" alt="Lenovo Logo" width={150} height={40} />
                      <Image src="/partners/huawei.jpg" alt="Huawei Logo" width={150} height={40} />
                      <Image src="/partners/adyce.jpg" alt="Adyce Logo" width={150} height={40} />
                      <Image src="/partners/nike.jpg" alt="Nike Logo" width={150} height={40} />
                      <Image src="/partners/genius.jpg" alt="Genius Logo" width={150} height={40} />
                    </div>
                  </div>
                </div>
              </div>
